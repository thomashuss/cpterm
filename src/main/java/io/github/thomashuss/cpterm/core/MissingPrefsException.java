...
/**
 * Indicates that a preferences field does not have a value when one is needed.
 */
public class MissingPrefsException
        extends PrefsException
{
    MissingPrefsException(String msg)
    {
        super(msg);
    }
}
