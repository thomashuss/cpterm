...
/**
 * Thrown when encountering any problem which would prevent conversion from continuing.  Assume that all
 * relevant information was logged prior to throwing this exception.
 */
